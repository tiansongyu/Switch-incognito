...
libs: $(CUSTOM_LIBS)
	@$(MAKE) -s --no-print-directory -C lib/imgui Makefile
	@$(MAKE) -s --no-print-directory -C lib/stb_image Makefile
	@:
...
clean:
	...
	@$(MAKE) -s --no-print-directory -C lib/imgui Makefile clean
	@$(MAKE) -s --no-print-directory -C lib/stb_image Makefile clean
